...
solarabund = {'pm': -9.0, 'tc': -9.0, 'er': 0.92, 'rh': 1.06, 'gd': 1.05, 'pb': 2.04, 'te': 2.18, 'sm': 0.94, 'au': 0.8, 'po': -9.0, 'pt': 1.62, 'sb': 1.01, 'lu': 0.09, 'ru': 1.76, 'ag': 1.2, 'ga': 3.08, 'ne': 7.97, 'ce': 1.58, 's': 7.15, 'mo': 1.94, 'zr': 2.53, 'kr': 3.25, 'na': 6.24, 'cr': 5.64, 'nd': 1.45, 'w': 0.65, 'si': 7.55, 'bi': 0.65, 'eu': 0.51, 'co': 4.87, 'la': 1.17, 'al': 6.45, 'dy': 1.13, 'ca': 6.29, 'k': 5.08, 'y': 2.21, 'b': 2.79, 'yb': 0.92, 'he': 10.93, 'hf': 0.71, 'ti': 4.91, 'tb': 0.32, 'mn': 5.48, 're': 0.26, 'ar': 6.44, 'se': 3.34, 'br': 2.54, 'os': 1.35, 'ta': -0.12, 'ir': 1.32, 'f': 4.42, 'ho': 0.47, 'c': 8.47, 'sc': 3.05, 'cd': 1.71, 'li': 3.26, 'rb': 2.52, 'n': 7.87, 'cs': 1.08, 'pd': 1.65, 'i': 1.55, 'as': 2.3, 'tl': 0.77, 'sn': 2.07, 'ni': 6.2, 'ba': 2.18, 'o': 8.73, 'cu': 4.25, 'xe': 2.24, 'hg': 1.17, 'v': 3.96, 'p': 5.41, 'sr': 2.88, 'ge': 3.58, 'tm': 0.12, 'fe': 7.54, 'mg': 7.64, 'in': 0.76, 'be': 1.3, 'pr': 0.76, 'cl': 5.23, 'nb': 1.41, 'zn': 4.63}

fig, ax = plt.subplots(1, figsize=(5,3.5), sharex=True, tight_layout={"pad":0.3})

header_row = []
columnlist =['[Fe/H]','O','Na','Rb','Y','Zr','Ba','La','Ce','Nd']
with open('out-abundances.txt','rb') as f:
    for line in f:
        row = line.split()
        if row[0].startswith("#"):
            header_row = row
